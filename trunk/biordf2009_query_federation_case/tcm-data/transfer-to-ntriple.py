...
association = '<http://purl.org/net/tcm/tcm.lifescience.ntu.edu.tw/id/association/'
...
type_association = '<http://purl.org/net/tcm/tcm.lifescience.ntu.edu.tw/Association>'
...
for row in reader:
    ...
    triple = association + str(j) + ">\ta\t" + type_association + " ;\n"
    triple = triple + "\t" + predicate_contextAssociation + "\t" + medicinename + medicineid + "> ;\n"
    triple = triple + "\t" + predicate_contextAssociation + "\t" + diseasename + diseaseid + "> ;\n"
