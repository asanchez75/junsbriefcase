 ...
 */
admed.tcm.Widget.prototype.findMedicineFromDbpedia = function( medicineName ) {
...
admed.tcm.Widget.Controller.prototype.findMedicineFromDbpedia = function( medicineName ) {
	try {
		...
		this._findMedicineFromDbpedia(medicineName, this._findMedicinesSuccess, this._findMedicinesFailure);
        	...
        	throw new admed.UnexpectedException("admed.tcm.Widget.Controller.prototype.findMedicineFromDbpedia", error);
    }
};
 ...
 */
admed.tcm.Widget.Controller.prototype._findMedicineFromDbpedia = function( medicineName, success, failure ) {
	try {
		admed.info("admed.tcm.Widget.Controller._findMedicineFromDbpedia :: request: "+medicineName);
		...
		this._service.findMedicineFromDbpedia(medicineName, success, failure);
        	...
        	throw new admed.UnexpectedException("admed.tcm.Widget.Controller.prototype._findMedicineFromDbpedia", error);
    }
};
