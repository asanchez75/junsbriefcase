...
infilename = '\\oxford\\svn\\biordf2009_query_federation_case\\genenamelinking\\results_using_deri\\auto_query_unique_mapping_tcm_genes.csv'
...
outfilename = '\\oxford\\svn\\biordf2009_query_federation_case\\genenamelinking\\results_using_deri\\gene-name-mapping-linkage-run-auto.ttl'
...
linkagerun = '<http://purl.org/net/tcm/id/linkage_run/1>'
voidlinkset = '<http://purl.org/net/tcm/id/linkset/1>'
...
### linkage_run
triple = linkagerun + "\t oddlinker:linkage_date \t \"2009-04-27\"^^xsd:date ;\n"
triple = triple + "\t oddlinker:linkage_method \t \"SparqlQuery\" ;\n"
